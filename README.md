...
The images below include **NCCL v2.28.9-1**, **HPC-X v2.24.1**,
and **cuDNN v9.13.0.50-1**.  
...
|----------------------------------------------------------------------------|------------|----------|
| ghcr.io/coreweave/nccl-tests:13.0.1-devel-ubuntu22.04-nccl2.28.9-1-3da7e7b | 22.04      | 13.0.1   |
| ghcr.io/coreweave/nccl-tests:12.9.1-devel-ubuntu22.04-nccl2.28.9-1-3da7e7b | 22.04      | 12.9.1   |
| ghcr.io/coreweave/nccl-tests:12.8.1-devel-ubuntu22.04-nccl2.28.9-1-3da7e7b | 22.04      | 12.8.1   |
| ghcr.io/coreweave/nccl-tests:12.6.3-devel-ubuntu22.04-nccl2.28.9-1-3da7e7b | 22.04      | 12.6.3   |
