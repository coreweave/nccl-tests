...
The images below include **NCCL v2.31.2-1**, **HPC-X v2.51**,
and **cuDNN v9.26.0.51-1**.  
...
| **Image Tag**                                                              | **CUDA** |
|----------------------------------------------------------------------------|----------|
| ghcr.io/coreweave/nccl-tests:13.3.1-devel-ubuntu26.04-nccl2.31.2-1-109629a | 13.3.1   |

### Ubuntu 24.04

| **Image Tag**                                                              | **CUDA** |
|----------------------------------------------------------------------------|----------|
| ghcr.io/coreweave/nccl-tests:13.3.0-devel-ubuntu24.04-nccl2.31.2-1-109629a | 13.3.0   |
| ghcr.io/coreweave/nccl-tests:13.2.1-devel-ubuntu24.04-nccl2.31.2-1-109629a | 13.2.1   |
| ghcr.io/coreweave/nccl-tests:13.1.2-devel-ubuntu24.04-nccl2.31.2-1-109629a | 13.1.2   |
| ghcr.io/coreweave/nccl-tests:13.0.3-devel-ubuntu24.04-nccl2.31.2-1-109629a | 13.0.3   |
| ghcr.io/coreweave/nccl-tests:12.9.2-devel-ubuntu24.04-nccl2.31.2-1-109629a | 12.9.2   |

### Ubuntu 22.04

| **Image Tag**                                                              | **CUDA** |
|----------------------------------------------------------------------------|----------|
| ghcr.io/coreweave/nccl-tests:13.3.0-devel-ubuntu22.04-nccl2.31.2-1-109629a | 13.3.0   |
| ghcr.io/coreweave/nccl-tests:13.2.1-devel-ubuntu22.04-nccl2.31.2-1-109629a | 13.2.1   |
| ghcr.io/coreweave/nccl-tests:13.1.2-devel-ubuntu22.04-nccl2.31.2-1-109629a | 13.1.2   |
| ghcr.io/coreweave/nccl-tests:13.0.3-devel-ubuntu22.04-nccl2.31.2-1-109629a | 13.0.3   |
| ghcr.io/coreweave/nccl-tests:12.9.2-devel-ubuntu22.04-nccl2.31.2-1-109629a | 12.9.2   |
| ghcr.io/coreweave/nccl-tests:12.8.2-devel-ubuntu22.04-nccl2.31.2-1-109629a | 12.8.2   |
| ghcr.io/coreweave/nccl-tests:12.6.3-devel-ubuntu22.04-nccl2.31.2-1-109629a | 12.6.3   |
